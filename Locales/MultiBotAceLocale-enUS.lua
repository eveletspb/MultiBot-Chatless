...
["info.inventory.item_use.reason.UNKNOWN"] = "The server returned an unknown item-use error.",
  ...
  ["tips.loot.disenchant"] = "Loot profile: Disenchant|cffffffff\nNormal loot + uncommon or better weapons and armor that are not Bind on Pickup.\nThis profile does not automatically disenchant items.|r",
  ...
  ["loot.profile.disenchant"] = "Disenchant",
  ...
  ["tips.units.actives"] = "Group|cffffffff\nShows bots currently in your party or raid.|r",
  ["tips.units.players"] = "My Bots|cffffffff\nShows your controllable bots and account alts, including offline alts.|r",
  ["tips.units.members"] = "Guild|cffffffff\nShows guild members, online and offline. Online members are listed first; offline members are dimmed.|r",
  ["tips.units.friends"] = "Friends|cffffffff\nShows your friends list, online and offline. Online friends are listed first; offline friends are dimmed.|r",
  ["tips.units.favorites"] = "Favorites|cffffffff\nShows bots explicitly marked as favorites.|r",
  ...
  ["command.status.summon"] = "Summon",
  ["command.status.order"] = "Group order",
  ["command.status.stay"] = "Current state: stay",
  ["command.status.follow"] = "Current state: follow",
  ["command.status.flee"] = "Current state: flee",
  ["command.status._ranged_flee"] = "Flee: ranged",
  ["command.status._melee_flee"] = "Flee: melee",
  ["command.status._healer_flee"] = "Flee: healers",
  ["command.status._dps_flee"] = "Flee: DPS",
  ["command.status._tank_flee"] = "Flee: tanks",
  ["command.status._tank_do_attack_my_target"] = "Tank attack: selected target",
  ["command.status.result.ok"] = "%s — applied to %d/%d bot(s).",
  ["command.status.result.partial"] = "%s — applied to %d/%d bot(s), failed: %d (%s).",
  ["command.status.result.failed"] = "%s — not applied (%s).",
  ["command.status.reason.NO_MATCH"] = "no controllable bots found",
  ["command.status.reason.NO_GROUP"] = "you are not in a group",
  ["command.status.reason.NO_TARGET"] = "no attack target selected",
  ["command.status.reason.FAILED"] = "the command failed",
  ["command.status.reason.PARTIAL"] = "some bots failed",
  ["command.status.reason.BOT_LIMIT"] = "the bot processing limit was reached",
  ["command.status.reason.RATE_LIMIT"] = "too many requests; try again shortly",
  ["command.status.reason.BAD_REQUEST"] = "invalid request",
  ["command.status.reason.BAD_SCOPE"] = "invalid target scope",
  ["command.status.reason.BAD_TARGET"] = "invalid target",
  ["command.status.reason.BAD_ENCODING"] = "invalid request encoding",
  ["command.status.reason.TIMEOUT"] = "request timed out",
  ["command.status.reason.DISCONNECTED"] = "bridge disconnected",
  ["command.status.reason.BRIDGE_UNAVAILABLE"] = "bridge command is unavailable",
  ["command.status.reason.SEND_FAILED"] = "request could not be sent",
  ["command.status.reason.UNKNOWN"] = "unknown error",
  ...
  ["tips.allbots.materialmail"] = "Mail materials to %s|cffffffff\nEligible online bots in your current party or raid send all supported materials to your current character.\nRandom bots and AddClass bots are excluded.|r\n\n|cffff0000Left-click to review and confirm.|r\n|cff999999(Executed by: eligible group Bots)|r",
  ["material.mail.confirm"] = "Send all supported materials from eligible online group or raid bots to %s?",
  ["material.mail.unavailable"] = "Material mail requires a connected bridge with GROUP_MATERIAL_MAIL_V1.",
  ["material.mail.no_group"] = "You must be in a party or raid.",
  ["material.mail.busy"] = "A material-mail batch is already running.",
  ["material.mail.send_failed"] = "The material-mail request could not be sent.",
  ["material.mail.confirm_unavailable"] = "The confirmation dialog is unavailable.",
  ["material.mail.result.summary"] = "Sent: %d bots, %d stacks, %d items, %d mails.",
  ["material.mail.result.remaining"] = "Left with bots due to batch limits or insufficient postage: %d stacks.",
  ["material.mail.result.error"] = "Material mail was not sent: %s.",
  ["material.mail.reason.DISABLED"] = "Mail sending by bots is disabled",
  ["material.mail.reason.BAD_REQUEST"] = "Invalid request",
  ["material.mail.reason.BAD_TOKEN"] = "Invalid request token",
  ["material.mail.reason.DUPLICATE"] = "Duplicate request",
  ["material.mail.reason.RATE_LIMIT"] = "Cooldown is active",
  ["material.mail.reason.BUSY"] = "Another batch is running",
  ["material.mail.reason.NO_GROUP"] = "No party or raid",
  ["material.mail.reason.NO_BOTS"] = "No eligible bots",
  ["material.mail.reason.RECIPIENT_CAPACITY"] = "Recipient mailbox is full",
  ["material.mail.reason.TRUNCATED"] = "Batch limits reached",
  ["material.mail.reason.FORBIDDEN"] = "Control is not allowed",
  ["material.mail.reason.RANDOM_BOT"] = "Random bots are excluded",
  ["material.mail.reason.ADDCLASS_BOT"] = "AddClass bots are excluded",
  ["material.mail.reason.CROSS_FACTION_MAIL"] = "Cross-faction mail is forbidden",
  ["material.mail.reason.BOT_UNAVAILABLE"] = "Bot unavailable",
  ["material.mail.reason.BOT_IN_COMBAT"] = "In combat",
  ["material.mail.reason.BOT_DEAD"] = "Dead",
  ["material.mail.reason.BOT_BUSY"] = "Bot busy",
  ["material.mail.reason.NO_MAILBOX"] = "No mailbox",
  ["material.mail.reason.NO_MATERIALS"] = "No supported materials",
  ["material.mail.reason.NOT_ENOUGH_MONEY"] = "Not enough money",
  ["material.mail.reason.LIMIT_REACHED"] = "Batch limit reached",
  ["material.mail.reason.VALIDATION_FAILED"] = "Inventory changed during validation",
  ["material.mail.reason.INTERNAL_ERROR"] = "Internal error",
  ["material.mail.reason.TIMEOUT"] = "Request timed out",
  ["material.mail.reason.DISCONNECTED"] = "Bridge disconnected",
  ["material.mail.reason.UNKNOWN"] = "Unknown error",
